...
export default function App() {
  ...
  const FileIconBadge = ({ type, size = 64 }: { type: FileItem['type']; size?: number }) => (
    <div
      className={`rounded-2xl bg-gradient-to-br ${iconMeta[type].grad} flex items-center justify-center shadow-md`}
        ...
        <main className="px-5 pt-6">
          ...
          {currentUser.role === 'admin1' && (
            <div className={`rounded-2xl ${cardClass} p-4 mb-8`}>
              <h3 className="font-bold mb-1">Ubah Kode Hadiah Admin</h3>
